<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contact_us.aspx.cs" Inherits="HomeServiceFinder.Pages.User.contact_us" %>
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-3 py-lg-0">
                    ...
                    <a href="contact_us.aspx" class="nav-item nav-link active">Contact Us</a>
                </div>
            </div>
        </nav>
